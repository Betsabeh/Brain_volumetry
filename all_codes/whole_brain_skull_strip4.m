...
for k=9:60
    ...
    [bin,skull_image,TP(m),FN(m),FP(m),TN(m),OM(m),acc(m)]=skull_strip4(a,k);
    m=m+1;
    filename = strcat('C:\betsabeh\my_project\volumetry\matlab\mine\thesis\skull_striped4_slices\normal_1mm_slices', sprintf( '%d',k ), '.jpeg' );
