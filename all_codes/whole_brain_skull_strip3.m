...
for k=9:60
    ...
    [bin,skull_image,TP(m),FN(m),FP(m),TN(m),OM(m),acc(m)]=skull_strip3(a,k);
    m=m+1;
    filename = strcat('C:\betsabeh\my_project\volumetry\matlab\mine\thesis\skull_striped3_slices\normal_1mm_slice', sprintf( '%d',k ), '.jpeg' );
