...
% % %     toc
% % %     save('svm_train_1vs_all_1mm.mat','fAlphaY','fSVs','fBias','fParameters','fnSV','fnLabel');
% % %     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%test data
% % %      m=1;
% % % % % %     s1=0;
% % % % % %     s2=0;
...
m=m+1;
s_num
  save('brain_1_vs_all_1mm_n0_r0.mat','acc_csf','acc_gry','acc_white','TP_csf','FP_csf','TP_gry','FP_gry','TP_wht','FP_wht','TP','FN','FP','TN','OM','ACC');  
close all;
    end
...
diff_white=r_white_volume-white_volume
     save('brainvolume_1_vs_all_1mm_n0_r0.mat','csf_volume','gry_volume','white_volume','r_csf_volume','r_gry_volume','r_white_volume');  
