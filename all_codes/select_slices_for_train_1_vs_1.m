...
% % svm_data(l:u,3)=reshape(y,n_row*n_col,1);
    ...
    toc
    save('svm_train_1vs_1.mat','fAlphaY','fSVs','fBias','fParameters','fnSV','fnLabel');
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%test data
     m=1;
% % %     s1=0;
% % %     s2=0;
...
close all;
    ...
    if (avg_csf(k)>max_csf)
     ...
     save('select1_vs_1.mat','avg_csf','avg_gry','avg_wht','slice_num_csf','slice_num_gry','slice_num_wht');  
end
