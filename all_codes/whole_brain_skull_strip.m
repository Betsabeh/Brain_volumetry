...
for k=50:153
    ...
    [bin,skull_image,TP(m),FN(m),FP(m),TN(m),OM(m),acc(m)]=skull_strip21(a,k);
    m=m+1;
    filename = strcat('C:\betsabeh\my_project\volumetry\matlab\mine\thesis\skull_striped_slices\normal_1mm_slice', sprintf( '%d',k ), '.jpeg' );
