...
% % % % % %%%save('brain_1_vs_1_1mm_n9_r20.mat','all_segments_1_vs_1','real_segments','acc_csf_vs1','acc_gry_vs1','acc_white_vs1','TP_csf_vs1','FP_csf_vs1','TP_gry_vs1','FP_gry_vs1','TP_wht_vs1','FP_wht_vs1','TP','FN','FP','TN','OM','ACC');  
...
m=m+1;
%%%save('brain_1_vs_all_1mm_n9_r20.mat','all_segments_1_vs_all','real_segments','acc_csf_vs_all','acc_gry_vs_all','acc_white_vs_all','TP_csf_vs_all','FP_csf_vs_all','TP_gry_vs_all','FP_gry_vs_all','TP_wht_vs_all','FP_wht_vs_all','TP','FN','FP','TN','OM','ACC');  
close all;
s_num
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1_vs_1 volume
...
%%%%%save('brainvolume_1_vs_1_1mm_n9_r20.mat','csf_volume','gry_volume','white_volume','r_csf_volume','r_gry_volume','r_white_volume');  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%1_vs_1ll volume
...
diff_gry=r_gry_volume-gry_volume
diff_white=r_white_volume-white_volume
%%save('brainvolume_1_vs_all_1mm_n9_r20.mat','csf_volume','gry_volume','white_volume','r_csf_volume','r_gry_volume','r_white_volume');  
