...
row=181;
col=217;
load('csf_trained_me-s.mat');
load('gry_trained_me-s.mat');
load('wht_trained_me-s.mat');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%test data
for s_num=10:10:150
...
% % %      save('brain_avg_n5_r40.mat','csf_segments','gry_segments','wht_segments','real_segments','acc_csf','acc_gry','acc_white','TP_csf','FP_csf','TP_gry','FP_gry','TP_wht','FP_wht','TP','FN','FP','TN','OM','ACC');  
    m=m+1;
    close all
    s_num
end
