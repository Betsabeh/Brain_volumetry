...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%test data
for s_num=20:10:150
    test_data = mireadimages ('C:\betsabeh\my_project\volumetry\matlab\data\phantom\ms\t1_ai_msles2_1mm_pn0_rf0.mnc',s_num);
    ...
    images_crisp = mireadimages ('C:\betsabeh\my_project\volumetry\matlab\data\phantom\ms\phantom_1[1].0mm_msles2_crisp.mnc',s_num);
    ...
    [fig_handle, image_handle, bar_handle] = viewimage(r1+r2+r3)  
   % save('brain_ms_n0_r0.mat','csf_segments','gry_segments','wht_segments','real_segments','acc_csf','acc_gry','acc_white','TP_csf','FP_csf','TP_gry','FP_gry','TP_wht','FP_wht','TP','FN','FP','TN','OM','ACC');  
    m=m+1;
    close all
    s_num
end
...
save('brainvolume_ms_1mm_n0_r0.mat','csf_volume','gry_volume','white_volume','r_csf_volume','r_gry_volume','r_white_volume','diff_csf','diff_gry','diff_white' );  
